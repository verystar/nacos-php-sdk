...
class Request
{
    ...
    public function debug()
    {
        return [
            ...
            'RequestHeader' => $this->http_header,
            'ResponseHeader' => $this->getHeader(),
        ];
    }
    ...
    private function defaultOptions(&$ch, $url)
    {
        ...
        if ($this->is_ajax) {
            curl_setopt($ch, CURLOPT_HTTPHEADER, ["X-Requested-With: XMLHttpRequest", "X-Prototype-Version:1.5.0"]);
        }
